...
import rsp.performance.eval.cqels.StreamGenerator;
...
//		System.out.println("Triple encode moment: "+System.nanoTime());
		StreamGenerator.getFirstEncode();
//		StreamGenerator.getEncode();
		return this.context.dictionary().getAllocateNodeId(node).getId();
	}
	
	public Node decode(Long id) {
//		System.out.println("Triple decode moment: "+System.nanoTime());
